...
def main():
    ...
    global routers
    routers = [
        {"ip": "192.168.100.1", "username": "cisco", "password": "cisco"},
    ...
    routers2 = [
        ...
        {"nombre": "Router D", "x": 600, "y": 300,"IP":"181.16.2.22"},
        {"nombre": "Router F", "x": 150, "y": 300,"IP":"192.168.100.100"},
    ...
    conexiones = [
        ...
        {"router1": "Router B", "router2": "Router D", "color": "black","IP":"172.16.4.0"},
        {"router1": "Router C", "router2": "Router D", "color": "black","IP":"172.16.3.0"},
        {"router1": "Router A", "router2": "Router E", "color": "black","IP":"172.16.1.19"},
